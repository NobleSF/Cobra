...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('admin_image', 'file')

        # Adding field 'Image.url'
        db.add_column('admin_image', 'url',
                      self.gf('django.db.models.fields.URLField')(default='http://www.theanou.com', max_length=200),
                      keep_default=False)

        # Adding field 'Country.calling_code'
        db.add_column('admin_country', 'calling_code',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Order.discount_charge'
        db.alter_column('admin_order', 'discount_charge', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Order.shipping_cost'
        db.alter_column('admin_order', 'shipping_cost', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))

        # Changing field 'Order.shipping_charge'
        db.alter_column('admin_order', 'shipping_charge', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Order.anou_charge'
        db.alter_column('admin_order', 'anou_charge', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Order.products_charge'
        db.alter_column('admin_order', 'products_charge', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Order.total_charge'
        db.alter_column('admin_order', 'total_charge', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Image.file'
        raise RuntimeError("Cannot reverse this migration. 'Image.file' and its values cannot be restored.")
        # Deleting field 'Image.url'
        db.delete_column('admin_image', 'url')

        # Deleting field 'Country.calling_code'
        db.delete_column('admin_country', 'calling_code')


        # Changing field 'Order.discount_charge'
        db.alter_column('admin_order', 'discount_charge', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Order.shipping_cost'
        db.alter_column('admin_order', 'shipping_cost', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Order.shipping_charge'
        db.alter_column('admin_order', 'shipping_charge', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Order.anou_charge'
        db.alter_column('admin_order', 'anou_charge', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Order.products_charge'
        db.alter_column('admin_order', 'products_charge', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Order.total_charge'
        db.alter_column('admin_order', 'total_charge', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Account.email'
        db.alter_column('admin_account', 'email', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
