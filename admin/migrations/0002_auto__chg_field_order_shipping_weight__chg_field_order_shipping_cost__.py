...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.shipping_weight'
        db.alter_column('admin_order', 'shipping_weight', self.gf('django.db.models.fields.FloatField')(null=True))
        ...
        # Changing field 'Order.shipped_on'
        db.alter_column('admin_order', 'shipped_on', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Order.received_on'
        db.alter_column('admin_order', 'received_on', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Order.shipping_weight'
        db.alter_column('admin_order', 'shipping_weight', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'Order.shipping_cost'
        db.alter_column('admin_order', 'shipping_cost', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'Order.shipped_on'
        db.alter_column('admin_order', 'shipped_on', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 2, 23, 0, 0)))

        # Changing field 'Order.received_on'
        db.alter_column('admin_order', 'received_on', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 2, 23, 0, 0)))
