...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SMS.order'
        db.add_column('communication_sms', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['public.Order'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Email.order'
        db.add_column('communication_email', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['public.Order'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SMS.order'
        db.delete_column('communication_sms', 'order_id')

        # Deleting field 'Email.order'
        db.delete_column('communication_email', 'order_id')
    ...
    models = {
        ...
        'communication.email': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['public.Order']", 'null': 'True', 'blank': 'True'}),
