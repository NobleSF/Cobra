...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product.is_sold'
        db.delete_column('seller_product', 'is_sold')

        # Adding field 'Product.approved'
        db.add_column('seller_product', 'approved',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.sold'
        db.add_column('seller_product', 'sold',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Product.is_sold'
        db.add_column('seller_product', 'is_sold',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Product.approved'
        db.delete_column('seller_product', 'approved')

        # Deleting field 'Product.sold'
        db.delete_column('seller_product', 'sold')
