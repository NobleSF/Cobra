...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('seller_seller', 'name')

        # Deleting field 'Seller.phone'
        db.delete_column('seller_seller', 'phone')

        # Deleting field 'Seller.email'
        db.delete_column('seller_seller', 'email')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Seller.phone'
        db.add_column('seller_seller', 'phone',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Seller.email'
        db.add_column('seller_seller', 'email',
