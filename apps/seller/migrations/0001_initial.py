...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('seller_asset', (
            ...
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seller.Image'], null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        ...
        db.create_table('seller_photo', (
            ...
            ('thumb', self.gf('django.db.models.fields.URLField')(max_length=200, null=True)),
            ('pinky', self.gf('django.db.models.fields.URLField')(max_length=200, null=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
