...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product.is_orderable'
        db.delete_column('seller_product', 'is_orderable')


    def backwards(self, orm):
        # Adding field 'Product.is_orderable'
        db.add_column('seller_product', 'is_orderable',
