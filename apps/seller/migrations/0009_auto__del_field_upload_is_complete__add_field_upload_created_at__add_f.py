...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Upload.is_complete'
        db.delete_column('seller_upload', 'is_complete')

        # Adding field 'Upload.created_at'
        db.add_column('seller_upload', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 10, 12, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Upload.complete_at'
        db.add_column('seller_upload', 'complete_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'Upload', fields ['public_id']
        db.create_unique('seller_upload', ['public_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Upload', fields ['public_id']
        db.delete_unique('seller_upload', ['public_id'])

        # Adding field 'Upload.is_complete'
        db.add_column('seller_upload', 'is_complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Upload.created_at'
        db.delete_column('seller_upload', 'created_at')

        # Deleting field 'Upload.complete_at'
        db.delete_column('seller_upload', 'complete_at')
