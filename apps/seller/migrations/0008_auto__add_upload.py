...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Upload'
        db.create_table('seller_upload', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('public_id', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('is_complete', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('seller', ['Upload'])


    def backwards(self, orm):
        # Deleting model 'Upload'
        db.delete_table('seller_upload')
    ...
    models = {
        ...
        'seller.upload': {
            ...
            'public_id': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
