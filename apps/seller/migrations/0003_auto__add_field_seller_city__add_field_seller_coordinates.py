...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Seller.city'
        db.add_column('seller_seller', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Seller.coordinates'
        db.add_column('seller_seller', 'coordinates',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Seller.city'
        db.delete_column('seller_seller', 'city')

        # Deleting field 'Seller.coordinates'
        db.delete_column('seller_seller', 'coordinates')
