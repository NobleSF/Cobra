...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.is_progress'
        db.add_column(u'seller_photo', 'is_progress',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Photo.is_progress'
        db.delete_column(u'seller_photo', 'is_progress')
    ...
    models = {
        ...
        u'seller.command': {
            ...
            'base_product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'commands'", 'null': 'True', 'to': u"orm['seller.Product']"}),
            'command': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['seller.Product']", 'unique': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
