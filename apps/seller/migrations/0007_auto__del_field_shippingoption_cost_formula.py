...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ShippingOption.cost_formula'
        db.delete_column('seller_shippingoption', 'cost_formula')


    def backwards(self, orm):
        # Adding field 'ShippingOption.cost_formula'
        db.add_column('seller_shippingoption', 'cost_formula',
                      self.gf('django.db.models.fields.CharField')(default='50', max_length=50),
                      keep_default=False)
