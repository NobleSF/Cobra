...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShippingOption.image'
        db.alter_column('seller_shippingoption', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seller.Image'], null=True, on_delete=models.SET_NULL))
        # Adding field 'Seller.bio_ol'
        db.add_column('seller_seller', 'bio_ol',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Seller.translated_by'
        db.add_column('seller_seller', 'translated_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='translator', null=True, to=orm['admin.Account']),
                      keep_default=False)

        # Adding field 'Seller.approved_at'
        db.add_column('seller_seller', 'approved_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Seller.deactive_at'
        db.add_column('seller_seller', 'deactive_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Asset.name_ol'
        db.add_column('seller_asset', 'name_ol',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Asset.description_ol'
        db.add_column('seller_asset', 'description_ol',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ShippingOption.image'
        db.alter_column('seller_shippingoption', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['seller.Image']))
        # Deleting field 'Seller.bio_ol'
        db.delete_column('seller_seller', 'bio_ol')

        # Deleting field 'Seller.translated_by'
        db.delete_column('seller_seller', 'translated_by_id')

        # Deleting field 'Seller.approved_at'
        db.delete_column('seller_seller', 'approved_at')

        # Deleting field 'Seller.deactive_at'
        db.delete_column('seller_seller', 'deactive_at')

        # Deleting field 'Asset.name_ol'
        db.delete_column('seller_asset', 'name_ol')

        # Deleting field 'Asset.description_ol'
        db.delete_column('seller_asset', 'description_ol')
