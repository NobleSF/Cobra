...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Asset.rank'
        db.alter_column('seller_asset', 'rank', self.gf('django.db.models.fields.SmallIntegerField')(default=1))
        # Adding unique constraint on 'Asset', fields ['ilk', 'rank', 'seller']
        db.create_unique('seller_asset', ['ilk', 'rank', 'seller_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Asset', fields ['ilk', 'rank', 'seller']
        db.delete_unique('seller_asset', ['ilk', 'rank', 'seller_id'])


        # Changing field 'Asset.rank'
        db.alter_column('seller_asset', 'rank', self.gf('django.db.models.fields.SmallIntegerField')(null=True))
