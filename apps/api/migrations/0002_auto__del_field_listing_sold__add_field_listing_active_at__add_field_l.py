...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'api_listing', 'sold')

        # Adding field 'Listing.active_at'
        db.add_column(u'api_listing', 'active_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Listing.deactive_at'
        db.add_column(u'api_listing', 'deactive_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Listing.on_hold_at'
        db.add_column(u'api_listing', 'on_hold_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Listing.approved_at'
        db.add_column(u'api_listing', 'approved_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Listing.sold_at'
        db.add_column(u'api_listing', 'sold_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Listing.is_orderable'
        db.add_column(u'api_listing', 'is_orderable',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'api_listing', 'sold',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Listing.active_at'
        db.delete_column(u'api_listing', 'active_at')

        # Deleting field 'Listing.deactive_at'
        db.delete_column(u'api_listing', 'deactive_at')

        # Deleting field 'Listing.on_hold_at'
        db.delete_column(u'api_listing', 'on_hold_at')

        # Deleting field 'Listing.approved_at'
        db.delete_column(u'api_listing', 'approved_at')

        # Deleting field 'Listing.sold_at'
        db.delete_column(u'api_listing', 'sold_at')

        # Deleting field 'Listing.is_orderable'
        db.delete_column(u'api_listing', 'is_orderable')
