...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'api_listing', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['admin.Category']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Listing.category'
        db.delete_column(u'api_listing', 'category_id')
