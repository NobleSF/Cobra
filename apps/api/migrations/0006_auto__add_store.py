...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Store'
        db.create_table(u'api_store', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('seller', self.gf('django.db.models.fields.related.OneToOneField')(related_name='store', unique=True, to=orm['seller.Seller'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('color', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True)),
        ...
        db.send_create_signal('api', ['Store'])


    def backwards(self, orm):
        # Deleting model 'Store'
        db.delete_table(u'api_store')
    ...
    models = {
        ...
        'api.listing': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['admin.Category']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'deactive_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_orderable': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'usd_price': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'})
        },
        'api.store': {
            ...
            'deactive_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'seller': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'store'", 'unique': 'True', 'to': "orm['seller.Seller']"}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
