...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'api_listing', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.OneToOneField')(related_name='listing', unique=True, to=orm['seller.Product'])),
        ...
        db.send_create_signal('api', ['Listing'])


    def backwards(self, orm):
        # Deleting model 'Listing'
        db.delete_table(u'api_listing')
