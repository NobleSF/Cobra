...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cart.wepay_checkout_id'
        db.add_column('public_cart', 'wepay_checkout_id',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cart.wepay_checkout_id'
        db.delete_column('public_cart', 'wepay_checkout_id')
