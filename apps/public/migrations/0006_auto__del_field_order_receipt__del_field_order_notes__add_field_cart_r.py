...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.receipt'
        db.delete_column('public_order', 'receipt')

        # Deleting field 'Order.notes'
        db.delete_column('public_order', 'notes')

        # Adding field 'Cart.receipt'
        db.add_column('public_cart', 'receipt',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cart.notes'
        db.add_column('public_cart', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Order.receipt'
        db.add_column('public_order', 'receipt',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.notes'
        db.add_column('public_order', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Cart.receipt'
        db.delete_column('public_cart', 'receipt')

        # Deleting field 'Cart.notes'
        db.delete_column('public_cart', 'notes')
