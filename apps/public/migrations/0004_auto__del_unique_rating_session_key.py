...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Rating', fields ['session_key']
        db.delete_unique('public_rating', ['session_key'])


    def backwards(self, orm):
        # Adding unique constraint on 'Rating', fields ['session_key']
        db.create_unique('public_rating', ['session_key'])
