...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('public_ranking', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['seller.Product'], unique=True)),
            ('photography', self.gf('django.db.models.fields.DecimalField')(default='0.50', max_digits=3, decimal_places=2)),
            ('price', self.gf('django.db.models.fields.DecimalField')(default='0.50', max_digits=3, decimal_places=2)),
            ('appeal', self.gf('django.db.models.fields.DecimalField')(default='0.50', max_digits=3, decimal_places=2)),
            ('new_product', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2)),
            ('new_store', self.gf('django.db.models.fields.DecimalField')(default='1.00', max_digits=3, decimal_places=2)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('public', ['Ranking'])


    def backwards(self, orm):
        # Deleting model 'Ranking'
        db.delete_table('public_ranking')
