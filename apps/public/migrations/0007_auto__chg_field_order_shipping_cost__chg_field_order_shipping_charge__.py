...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('public_order', 'shipping_cost', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))

        # Changing field 'Order.shipping_charge'
        db.alter_column('public_order', 'shipping_charge', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

        # Changing field 'Order.seller_paid_amount'
        db.alter_column('public_order', 'seller_paid_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))

        # Changing field 'Order.discount_charge'
        db.alter_column('public_order', 'discount_charge', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

        # Changing field 'Order.anou_charge'
        db.alter_column('public_order', 'anou_charge', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

        # Changing field 'Order.products_charge'
        db.alter_column('public_order', 'products_charge', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

        # Changing field 'Order.total_charge'
        db.alter_column('public_order', 'total_charge', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Order.shipping_cost'
        db.alter_column('public_order', 'shipping_cost', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))

        # Changing field 'Order.shipping_charge'
        db.alter_column('public_order', 'shipping_charge', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Order.seller_paid_amount'
        db.alter_column('public_order', 'seller_paid_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))

        # Changing field 'Order.discount_charge'
        db.alter_column('public_order', 'discount_charge', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Order.anou_charge'
        db.alter_column('public_order', 'anou_charge', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Order.products_charge'
        db.alter_column('public_order', 'products_charge', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Order.total_charge'
        db.alter_column('public_order', 'total_charge', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))
    ...
    models = {
        ...
        'public.order': {
            ...
            'cart': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['public.Cart']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'discount_charge': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '2'}),
