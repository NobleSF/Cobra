...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field promotions on 'Cart'
        db.create_table('public_cart_promotions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cart', models.ForeignKey(orm['public.cart'], null=False)),
            ('promotion', models.ForeignKey(orm['public.promotion'], null=False))
        ))
        db.create_unique('public_cart_promotions', ['cart_id', 'promotion_id'])


    def backwards(self, orm):
        # Removing M2M table for field promotions on 'Cart'
        db.delete_table('public_cart_promotions')
