...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cart.anou_checkout_id'
        db.add_column('public_cart', 'anou_checkout_id',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cart.anou_checkout_id'
        db.delete_column('public_cart', 'anou_checkout_id')
