...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'public_order', 'notes',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'public_order', 'notes')
    ...
    models = {
        ...
        u'public.cart': {
            ...
            'promotions': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['public.Promotion']", 'symmetrical': 'False'}),
        ...
        u'public.item': {
            ...
            'cart': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['public.Cart']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['seller.Product']"})
        },
        u'public.order': {
            'Meta': {'object_name': 'Order'},
            'anou_charge': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '2'}),
            'cart': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'orders'", 'to': u"orm['public.Cart']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'products': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['seller.Product']", 'symmetrical': 'False'}),
            ...
            'seller_paid_receipt': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['seller.Image']", 'null': 'True', 'blank': 'True'}),
            ...
            'shipping_option': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['seller.ShippingOption']", 'null': 'True', 'blank': 'True'}),
        ...
        u'public.ranking': {
            ...
            'product': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['seller.Product']", 'unique': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'public.rating': {
            ...
            'subject': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['admin.RatingSubject']"}),
