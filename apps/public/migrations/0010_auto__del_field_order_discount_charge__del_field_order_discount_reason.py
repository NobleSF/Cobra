...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.discount_charge'
        db.delete_column('public_order', 'discount_charge')

        # Deleting field 'Order.discount_reason'
        db.delete_column('public_order', 'discount_reason')


    def backwards(self, orm):
        # Adding field 'Order.discount_charge'
        db.add_column('public_order', 'discount_charge',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)

        # Adding field 'Order.discount_reason'
        db.add_column('public_order', 'discount_reason',
