...
from apps.public.controllers.events import invalidate_cache

@access_required('admin')
def rebuildProductRankings(request):
  from apps.public.controllers.events import rebuildRankings
  rebuildRankings()
...
def rebuildStorePage(request, seller_id):
  from apps.public.controllers.events import invalidate_seller_cache
  try:
...
def cacheReset(request):
  from apps.public.controllers.events import invalidateAllProductCaches, invalidateAllSellerCaches
  try:
