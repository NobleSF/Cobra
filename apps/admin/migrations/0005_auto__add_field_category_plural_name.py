...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.plural_name'
        db.add_column('admin_category', 'plural_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.plural_name'
        db.delete_column('admin_category', 'plural_name')
