...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.ordering_name'
        db.add_column('admin_category', 'ordering_name',
                      self.gf('django.db.models.fields.CharField')(default='default name', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.ordering_name'
        db.delete_column('admin_category', 'ordering_name')
