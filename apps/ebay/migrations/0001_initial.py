...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ebay_listing', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.OneToOneField')(related_name='ebay_listing', unique=True, to=orm['seller.Product'])),
        ))
        db.send_create_signal('ebay', ['Listing'])


    def backwards(self, orm):
        # Deleting model 'Listing'
        db.delete_table('ebay_listing')
    ...
    models = {
        ...
        'ebay.listing': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'ebay_listing'", 'unique': 'True', 'to': "orm['seller.Product']"})
        },
        'seller.asset': {
