...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Asset.ilk'
        db.add_column('seller_asset', 'ilk',
                      self.gf('django.db.models.fields.CharField')(default='artisan', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Asset.ilk'
        db.delete_column('seller_asset', 'ilk')
