...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Seller.email'
        db.alter_column('seller_seller', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

    def backwards(self, orm):

        # Changing field 'Seller.email'
        db.alter_column('seller_seller', 'email', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
