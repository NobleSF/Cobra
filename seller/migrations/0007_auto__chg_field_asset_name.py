...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('seller_asset', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Asset.name'
        db.alter_column('seller_asset', 'name', self.gf('django.db.models.fields.CharField')(default='name', max_length=50))
