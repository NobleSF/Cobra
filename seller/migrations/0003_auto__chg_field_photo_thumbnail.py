...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('seller_photo', 'thumbnail', self.gf('django.db.models.fields.URLField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Photo.thumbnail'
        db.alter_column('seller_photo', 'thumbnail', self.gf('django.db.models.fields.CharField')(max_length=100))
